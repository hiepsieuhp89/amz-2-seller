  ...
  return (
    <div className="bg-red border-b px-4 sm:px-6 md:px-8 lg:px-[104px] py-4 sm:py-6 bg-white">
      <div className="container mx-auto max-w-[1440px] flex flex-wrap sm:flex-nowrap items-center">
        <div className="w-12 h-12 sm:w-16 sm:h-16 border-2 border-main-golden-orange rounded-full bg-gray-200 items-center justify-center overflow-hidden mr-3 sm:mr-4 p-2 bg-white flex-shrink-0">
          <Image
        ...
        <div className="flex-1 mb-3 sm:mb-0">
          <div className="flex items-center">
            <h1 className="text-base sm:text-xl font-bold text-ellipsis overflow-hidden">{profileData?.data?.shopName || profileData?.data?.username}</h1>
          ...
          <div className="text-xs sm:text-sm text-gray-600 line-clamp-1">{profileData?.data?.shopAddress || profileData?.data?.address}</div>
        </div>
        <div className="flex flex-col items-start sm:items-end ml-auto sm:ml-0 order-3 sm:order-none w-full sm:w-auto mt-3 sm:mt-0">
          ...
          <div className="text-sm sm:font-medium">{formatDate(profileData?.data?.createdAt || '')}</div>
        </div>
